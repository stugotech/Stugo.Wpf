...
namespace Stugo.Wpf.Behaviours
{
    ...
    /// minimise the parent window when clicked.
    /// </summary>
    public static class MinimiseButtonBehaviour
    {
        public static readonly DependencyProperty EnabledProperty =
            DependencyProperty.RegisterAttached("Enabled", typeof(bool), typeof(MinimiseButtonBehaviour), new PropertyMetadata(false, EnabledChanged));
